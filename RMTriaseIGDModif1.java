...
//                    }
    ...
    private void initComponents() {
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-05-2026 08:16:37" }));
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-05-2026 08:16:43" }));
        ...
        DTPCari5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-05-2026" }));
        ...
        DTPCari6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-05-2026" }));
        ...
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(TabTriase.getSelectedIndex()==0){
                if(PrimerKeluhanUtama.getText().trim().equals("")){
                    ...
                    // [PERBAIKAN] Mengganti pemanggilan cbPrioritas1.getText() di baris ini dengan variabel esi1
            ...
            try {
                ...
                try {
                    ...
                    if(rs.next()){
                        ...
                        // ---- Set Tampilan HTML ke Kotak Kanan ----
