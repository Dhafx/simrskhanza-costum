...
//                    }
    ...
    private void initComponents() {
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-05-2026 22:34:10" }));
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-05-2026 22:34:15" }));
        ...
        DTPCari5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-05-2026" }));
        ...
        DTPCari6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-05-2026" }));
            ...
            if(TabTriase.getSelectedIndex()==0){
                if(PrimerKeluhanUtama.getText().trim().equals("")){
                    ...
                    if(cekYa1.isSelected()==true){
                        param1="Ya";
                    }else if(cekYa2.isSelected()==true){
                        param2="Ya";
                    }else if(cekYa3.isSelected()==true){
                        param3="Ya";
                    }else if(cekYa4.isSelected()==true){
                        param4="Ya";
                    }
                    getNIlaiisolasi();
                    getPsikologi();
...
//                        }
                    ...
                    if(Sequel.menyimpantf("data_triase_igd", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 33, new String[]{
                        ...
                        PrimerSaturasi.getText(), PrimerNyeri.getText(),PrimerKeluhanUtama.getText(),PrimerKubutuhanKusus.getSelectedItem().toString(),PrimerCatatan.getText(),cbPrioritas1.getText(),esi2, esi3, esi4, esi5, param1, param2, param3, param4, getIsolasi, getPsikologi, comboBox1.getSelectedItem().toString(),
            ...
            Valid.textKosong(btnKasus,"Keterangan");
               ...
               if (TabTriase.getSelectedIndex() == 0) {
                if (PrimerKeluhanUtama.getText().trim().equals("")) {
                    ...
                    if (Sequel.mengedittf("data_triase_igd", "no_rawat=?", "no_rawat=?,tgl_kunjungan=?,cara_masuk=?,alat_transportasi=?,alasan_kedatangan=?,keterangan_kedatangan=?,"
                            + "kode_kasus=?,tekanan_darah=?,nadi=?,pernapasan=?,suhu=?,saturasi_o2=?,nyeri=?,keluhan_utama=?,ESI1=?,ESI2=?,ESI2=?,ESI4=?,ESI5=?", 20, new String[]{
                                TNoRw.getText(), Valid.SetTgl(TanggalKunjungan.getSelectedItem() + "") + " " + TanggalKunjungan.getSelectedItem().toString().substring(11, 19),
                                CaraMasuk.getSelectedItem().toString(), Transportasi.getSelectedItem().toString(), AlasanKedatangan.getSelectedItem().toString(),
                                ...
                                PrimerKeluhanUtama.getText(), cbPrioritas1.getText(), esi2, esi3, esi4, esi5,
            ...
            if(evt.getKeyCode()==KeyEvent.VK_SHIFT){
                ...
                if(tbTriase.getSelectedRow()!= -1){
                    try {
                        ...
                        }else if(tbTriase.getValueAt(tbTriase.getSelectedRow(),21).toString().equals("RISIKO TINGGI")){
                           cbPrioritas2b.setSelected(true);
                        }else if(tbTriase.getValueAt(tbTriase.getSelectedRow(),22).toString().equals("NYERI / DISTRES BERAT")){
                        ...
                        }else if(tbTriase.getValueAt(tbTriase.getSelectedRow(),23).toString().equals("SATU")){
                            cbPrioritas543.setSelectedIndex(1);
                        }else if(tbTriase.getValueAt(tbTriase.getSelectedRow(),23).toString().equals("BANYAK (>2)")){
                        ...
                        ps=koneksi.prepareStatement(
                            "select data_triase_igd.keluhan_utama,data_triase_igd.kebutuhan_khusus,data_triase_igd.catatan,"+
                            "data_triase_igdprimer.plan,data_triase_igdprimer.tanggaltriase,data_triase_igdprimer.nik,data_triase_igd.tekanan_darah,"+
                            "data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,data_triase_igd.nyeri,"+
...
////                ps = koneksi.prepareStatement(
////                        "select data_triase_igd.keluhan_utama,data_triase_igd.kebutuhan_khusus,data_triase_igd.catatan,\n"
////                        + "data_triase_igd.tgl_kunjungan,data_triase_igd.tekanan_darah,data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,"
////                        + "data_triase_igd.nyeri,data_triase_igd.no_rawat,data_triase_igd.suhu,data_triase_igd.nyeri,data_triase_igd.tekanan_darah,"
////                        + "data_triase_igd.nadi,data_triase_igd.saturasi_o2,data_triase_igd.pernapasan from data_triase_igd WHERE data_triase_igd.no_rawat=?");
//                try {
//                    ps.setString(1, tbTriase.getValueAt(tbTriase.getSelectedRow(), 0).toString());
//                    rs = ps.executeQuery();
//                    if (rs.next()) {
